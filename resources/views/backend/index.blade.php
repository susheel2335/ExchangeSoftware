...
<body ng-app="myApp">
 ...
 <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
  ...
  <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
    ...
    <a class="dropdown-item"  href="/admin/kycs/pending">KYC Pending</a>  
    
     <a class="dropdown-item" href="/admin/kycs/approved">KYC Approved</a>
     
     
     <a class="dropdown-item" href="/admin/kycs/no">No KYC</a>
    ...
    <li class="nav-item dropdown">
        ...
        <a class="nav-link dropdown-toggle" href="/admin/currencies" id="dropdown01"
        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Manage Currencies
    ...
    <a  class="dropdown-item"  href="/admin/currencies">All Currencies</a>

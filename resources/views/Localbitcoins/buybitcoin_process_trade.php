...
<h3>{{ __('p2p.sellinginadvirtisement')}} #{{ $po->trade_id  }} (Other online payment) to {{ $po->trade->username  }} {{ __('p2p.attheexchangerate') }}   	30,642.55 BRL .</h3> 
...
{{ $po->username  }} {{ __('p2p.btcsenttobuyer') }} 2019-11-29 07:17:35+00:00

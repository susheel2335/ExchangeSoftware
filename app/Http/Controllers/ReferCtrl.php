...

{
 ...
 //$this->awardreferincome( $this->request['plan'],  $this->request['payment_method'] );
  ...
  $user = User::find((Auth::user()->id));
       ...
       return redirect('/'.app()->getLocale() .'/system/transactions');
...
$mlm_investment_transactions = mlm_investment_transactions::all();
...
$mlm_investment_orders = mlm_investment_orders::all();
